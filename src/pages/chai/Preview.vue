...
<template>
    ...
    <div class="flex flex-row items-center justify-center w-full md:px-5 lg:px-[15%]">
        <img src="/chai-preview.png" alt="Chai Preview" class="rounded-lg xl:rounded-lg w-full object-cover" />
    </div>
