  ...
  <div>
    ...
    <div class="snap-center flex-shrink">
      <div class="flex flex-row justify-around items-center sm:mb-2 mb-0">
        ...
        <div class="self-end transform translate-z-5">
        ...
        <div
          class="rounded-full overflow-hidden bg-gray-800/40 dark:bg-gray-200/5 p-1 shadow-xl shrink-0 md:block hidden translate-z-5">
